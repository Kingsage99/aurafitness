    ...
    <>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px 26px 0' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32, marginTop: 16 }}>
          <div style={{ width: 64, height: 64, borderRadius: 20, background: 'linear-gradient(135deg,#7C3AED,#5B21B6)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px' }}>
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3l2.2 5.5L20 9l-4.5 3.8L17 19l-5-3-5 3 1.5-6.2L4 9l5.8-.5z"/></svg>
          </div>
          <div style={{ fontFamily: "'DM Serif Display',serif", fontSize: 28, color: '#2E1065' }}>Aura</div>
          <div style={{ fontSize: 13, color: '#8478A0', marginTop: 4 }}>
        ...
        <button onClick={handleGoogle} disabled={loading}
          style={{ width: '100%', height: 52, borderRadius: 16, border: '1.5px solid #EDE4F8', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, fontSize: 15, fontWeight: 700, color: '#2E1065', cursor: 'pointer', marginBottom: 20, boxShadow: '0 4px 14px rgba(76,36,120,.07)' }}>
